...
from naskpy.image_processing import get_remote_image, resize, resize_by_height, resize_by_width, to_square
    ...
    def test_to_square(self):
        ...
        for image in images:
            for sl in side_length:
                for cc in ccs:
                    image_squared = to_square(
                        image, sl, fill_color=(255, 255, 255, 0), center_crop=cc
                    )  # white background
